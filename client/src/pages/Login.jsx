...
const Login = () => {
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      {/* left side : branding */}
      <div
        className="flex-1 flex flex-col items-start justify-between p-6 md:p-10
      lg:pl-40"
      >
        <img src={assets.logo} alt="" className="h-12 object-contain" />
        <div>
          <div className="flex items-centre gap-3 mb-4 max-md:mt-10">
      ...
      <div className="flex-1 flex items-centre justify-center p-6 sm:p-10">
        <SignIn />
