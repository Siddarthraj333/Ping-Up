...
import {Users, UserPlus, UserCheck, UserRoundPen, MessageSquare}
 from 'lucide-react'
    ...
    <div className='min-h-screen bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        rounded-md p-1 bg-white shadow-sm'>
          {
            dataArray.map((tab)=>(
              <button onClick={()=> setCurrentTab(tab.label)} key={tab.label} className={`flex   items-center px-3 py-1 text-sm cursor-pointer
             ...
             shadow rounded-md'>
              ...
              <div className='flex-1'>
                ...
                <div className='flex max-sm:flex-col gap-2 mt-4'>
                       {
                        <button onClick={()=> navigate(`/profile/${user._id}`)}className='w-full p-2 text-sm rounded bg-gradient-to-r from-purple-500 to-purple-600
