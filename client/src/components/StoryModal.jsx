...
const StoryModal = ({ setShowModal, fetchStories }) => {
  ...
  return (
    <div
      className="fixed inset-0 z-110 min-h-screen bg-black/70 backdrop-blur
      ...
      <div className="w-full max-w-md">
          ...
          {mode === "text" && (
            <textarea
              className="bg-transparent text-white w-full h-full
                    p-6 text-xl resize-none focus:outline-none"
        ...
        <button onClick={()=> { toast.promise(handelCreateStory(), {
          ...
          className="flex items-center justify-center gap-2 text-white
                           ...
                           hover:from-indigo-600 hover:to- bg-purple-700 active:scale-95 transition
                           cursor-pointer"
        >
