...
const ProfileModal = ({ setShowEdit }) => {
  ...
  useEffect(() => {
    if (bioRef.current) {
      bioRef.current.style.height = "auto"; // reset height
      bioRef.current.style.height = bioRef.current.scrollHeight + "px"; // set height to fit content
    }
  }, [editForm.bio]);
            ...
            <div className="flex flex-col items-start gap-3">
              ...
              >
                ...
                <div className="group relative">
                  ...
                  />
                  <div
                    className="absolute hidden group-hover:flex top-0 left-0 right-0 bottom-0 
                               bg-black/40 rounded-full items-center justify-center"
                  >
