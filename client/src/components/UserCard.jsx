  ...
  return (
    ...
    border-gray-200 rounded-md'>
        <div className='text-center'>
            ...
            {user.bio && <p className='text-gray-600 mt-2 text-center
            text-sm px-4'>{user.bio}</p>}
        </div>
        ...
        <div className='flex mt-4 gap-2'>
            {/* follow button */}
            <button onClick={handelFollow} disabled={currentUser?.following.includes(user._id)}className='w-full py-2 rounded-md flex justify-center
            items-center gap-3 bg-gradient-to-r from-indigo-500 to-purple-600
            ...
            <button onClick={handelConnectionRequest} className='flex items-center justify-center w-16 border text-slate-500 group 
