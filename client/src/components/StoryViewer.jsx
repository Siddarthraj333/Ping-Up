...
const StoryViewer = ({viewStory, setViewStory}) => {
    ...
    const renderContent = ()=> {
        switch (viewStory.media_type) {
            case 'image':
                return(
                    <img src={viewStory.media_url}  alt='' className='
  ...
  return (
    ...
    flex items-center justify-center' style={{background: viewStory.media_type
        ...
        {/* progress bar */}
         <div className='absolute top-0 left-0 w-full h-1 bg-gray-700'>
            ...
            px-4 sm:px-8 backdrop-blur-2xl rounded bg-black/50'>
